...
public class MondayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button = v.findViewById(R.id.mfbutton5);
        recyclerView= v.findViewById(R.id.mfrec);

        arrayList_parent = new ArrayList<>();


        query = fstore.collection("class").document(userID).collection("Monday");
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int positions, @NonNull final model2 model2) {
                ...
                holder.drop.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        DocumentReference documentReference = fstore.collection("class").document(userID).collection("Monday").document(model2.getRef());
