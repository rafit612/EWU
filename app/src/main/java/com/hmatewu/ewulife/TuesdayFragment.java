...
public class TuesdayFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        button = v.findViewById(R.id.tfbutton5);

        recyclerView= v.findViewById(R.id.tfrec);

        arrayList_parent = new ArrayList<>();


        query = fstore.collection("class").document(userID).collection("Tuesday");
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, int positions, @NonNull final model2 model2) {
                ...
                holder.drop.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        DocumentReference documentReference = fstore.collection("class").document(userID).collection("Tuesday").document(model2.getRef());
