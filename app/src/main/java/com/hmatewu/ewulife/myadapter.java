...
public class myadapter extends FirebaseRecyclerAdapter<model,myadapter.myviewholder>
{
    ...
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull model model)
    {
        ...
        holder.section.setText("Section-"+(Long.toString(model.getSection())));
    ...
    {
        TextView instructor,course,day,time,section;
        ...
        public myviewholder(@NonNull View itemView)
        {
            ...
            day=(TextView)itemView.findViewById(R.id.textView28b);
            time=(TextView)itemView.findViewById(R.id.textView28a);
            section=(TextView)itemView.findViewById(R.id.textView25);
